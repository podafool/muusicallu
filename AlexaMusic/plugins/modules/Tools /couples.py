...
from AlexaMusic.mongo.couples_db import _get_image, get_couple
...
async def ctest(_, message):
    ...
    try:
     ...
     #  if not is_selected:
         ...
         TXT = f"""
❀ꗥ～ꗥ❀ 𝐍𝐚𝐥𝐥𝐚 𝐊𝐚𝐚𝐥𝐚𝐦 𝐊𝐨𝐫𝐚𝐤𝐚 𝐏𝐨𝐠𝐮𝐭𝐡𝐮.. ❀ꗥ～ꗥ❀
**𝐓ᴏᴅᴀʏ's 𝐒ᴇʟᴇᴄᴛᴇᴅ 𝐂ᴏᴜᴘʟᴇs 🎉 :
✧══════•❁♡︎❁•══════✧
{N1} + {N2} = 💗
✧══════•❁♡︎❁•══════✧
𝐍ᴇxᴛ 𝐂ᴏᴜᴘʟᴇs 𝐖ɪʟʟ 𝐁ᴇ 𝐒ᴇʟᴇᴄᴛᴇᴅ 𝐎ɴ {tomorrow} !!- 𝙸𝚟𝚊𝚗 𝙿𝚘𝚒 𝚂𝚘𝚕𝚞𝚛𝚊𝚗 𝚁𝚎𝚏𝚎𝚛𝚎𝚎 -**
"""
